...
const portfolioData: Project[] = [
  {
    ...
    description:
      "Aplicativo PWA para pedidos online de pizzaria com menu dinâmico e integração ao WhatsApp. Uma solução moderna para delivery, oferecendo uma experiência de compra rápida e intuitiva para o cliente.",
  ...
  },
  {
    ...
    description:
      "Site institucional para apresentação de móveis planejados e captação de clientes. Uma vitrine digital elegante e funcional para destacar a qualidade dos projetos e atrair novos interessados.",
